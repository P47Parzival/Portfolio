...
const CardContainer = () => {
  return (
    <StyledWrapper>
      <div className="card">
        <a className="social-link1" href='https://www.instagram.com/dhruvv_2804?igsh=ZGw2cHoxbmh0MHEw'>
        ...
        <a className="social-link2" href='https://x.com/DhruvM2804?t=6-81mBXINSra_tMQg3D6og&s=09'>
        ...
        <a className="social-link3" href='https://discord.gg/cR8a2qcV'>
